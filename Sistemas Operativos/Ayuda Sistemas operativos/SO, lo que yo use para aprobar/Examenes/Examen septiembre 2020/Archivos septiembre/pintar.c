...
void SignalWorkDone(int numHijo){
	...
	//BEGIN TODO
		...
		sigqueue(...);  //Usamos sigqueue para enviar señales en tiempo real
	//END TODO
}
...
void SignalWorkStart(int pid){
	//BEGIN TODO
		...
		...   //usamos kill para enviar señales normales
	//END TODO
