...
int main( int args, char *argv[] )
{
    ...
    //Begin TODO-------------------------------------
        ...
        //Usar la variable maxPiezas para almacenar el número de piezas máximo que se asignan a un hijo
